...
struct MYSQLCONNECTORUE5PLUGIN_API FMySQLConnectorTableField
{
...
USTRUCT(BlueprintType)
struct MYSQLCONNECTORUE5PLUGIN_API FMySQLConnectorPrimaryKey
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct MYSQLCONNECTORUE5PLUGIN_API FMySQLConnectorTable
{
	GENERATED_USTRUCT_BODY()
