...
struct MYSQLCONNECTORUE5PLUGIN_API FMySQLConnectorConnectionStruct
{
...
USTRUCT(BlueprintType)
struct MYSQLCONNECTORUE5PLUGIN_API FMySQLConnectorKeyValuePair
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct MYSQLCONNECTORUE5PLUGIN_API FMySQLConnectorQueryResultRow
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct MYSQLCONNECTORUE5PLUGIN_API FMySQLConnectoreQueryResult
{
	GENERATED_USTRUCT_BODY()
...
*/
UCLASS()
class MYSQLCONNECTORUE5PLUGIN_API UMySQLDatabase : public UObject
{
