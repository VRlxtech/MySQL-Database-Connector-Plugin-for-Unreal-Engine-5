...
struct MYSQLCONNECT_API FMySQLConnectorConnectionStruct
{
...
USTRUCT(BlueprintType)
struct MYSQLCONNECT_API FMySQLConnectorKeyValuePair
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct MYSQLCONNECT_API FMySQLConnectorQueryResultRow
{
	GENERATED_USTRUCT_BODY()
...
USTRUCT(BlueprintType)
struct MYSQLCONNECT_API FMySQLConnectoreQueryResult
{
	GENERATED_USTRUCT_BODY()
...
*/
UCLASS()
class MYSQLCONNECT_API UMySQLDatabase : public UObject
{
